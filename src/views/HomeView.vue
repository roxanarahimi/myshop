<template>
  ...
  <div class="row bg-light pt-md-5 ">
    <div class="col-lg-10 mx-auto row px-5 py-4 py-md-0">
      <div v-for="item in categories" class="col-4  col-md-4 p-3 p-md-4">
...
<!--       <small class="mb-0 cat-txt">65 محصول</small>&lt;!&ndash;      &ndash;&gt;-->
  ...
  <div class=" d-flex flex-wrap justify-content-between pt-4 " style="background-color: rgba(230,0,118,0.15)">
